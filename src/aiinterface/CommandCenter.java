...
public class CommandCenter {
	...
	/**
	 * Converts the action name to a core.command and creates a key corresponding to the core.command.
	 *
	 * @param str
	 *            an action name
	 */
	...
	/**
	 * Creates a key corresponding to a core.command name.
	 *
	 * @param str
	 *            a core.command name
	 */
	...
	/**
	 * Reverses the core.command horizontally according to the direction the character is facing.
	 *
	 * @param commands
	 *            an array containing the core.command converted from an action name
	 *
	 * @return an array that contains the core.command after processing
	 */
