...
public class Character {
    ...
    /**
     * Returns the current core.image of the character according to the current
     * action and frame number.
     *
     * @return the current core.image of the character according to the current
     * action and frame number
     */
     ...
     *                motion's core.command. {@code true} if the character can run,
