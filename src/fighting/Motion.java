...
public class Motion {
	...
	/**
	 * The list of data structure for core.image.
	 */
	...
	private Image invert(Image image) {
		...
		//temp.setData(core.image.getBufferedImage().getData());
		//BufferedImage invertedImage = core.image.getBufferedImage();
	...
	/**
	 * Returns the current core.image of the character.
	 *
	 * @param nowFrame
	 *            the current frame
	 * @return the current core.image of the character
	 */
	...
	/**
	 * Sets the {@link #speedX} core.setting, which stores the horizontal speed
	 * applied to a character using this motion.
	 *
	 * @param speedX
	 *            the value to assign to the {@link #speedX} core.setting
	 */
	...
	/**
	 * Sets the {@link #speedY} core.setting, which stores the vertical speed applied
	 * to a character using this motion.
	 *
	 * @param speedY
	 *            the value to assign to the {@link #speedY} core.setting
	 */
	...
	/**
	 * Sets the {@link #cancelAbleFrame} core.setting. This indicates the first frame
	 * when this motion can be cancelled.
	 *
	 * @param cancelAbleFrame
	 *            the value to assign to the {@link #cancelAbleFrame} core.setting
	 */
	...
	/**
	 * Sets the {@link #cancelAbleMotionLevel} core.setting. This indicates the
	 ...
	 *
	 * @param motionLevel
	 *            the value to assign to the {@link #motionLevel} core.setting
	 */
	...
	/**
	 * Sets the {@link #state} core.setting, which represents the state assigned to
	 * the character at the end of this motion.
	 *
	 * @param state
	 *            the value to assign to the {@link #state} core.setting
	 */
	...
	/**
	 * Sets the {@link #landingFlag} core.setting, a flag encoding whether the
	 * Landing motion can cancel this motion.
	 *
	 * @param landingFlag
	 *            the value to assign to the {@link #landingFlag} core.setting
	 */
