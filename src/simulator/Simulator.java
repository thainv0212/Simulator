...
public class Simulator {
	...
	public static void main(String[] args) {
		...
		f.initialize();
		GameData gameData = new GameData(f.getCharacters());
		Simulator s = new Simulator(gameData);
		Deque<Action> tempP1Act = new LinkedList<>();
		tempP1Act.addLast(Action.STAND_GUARD);
		tempP1Act.addLast(Action.STAND_GUARD);
		tempP1Act.addLast(Action.STAND_GUARD);
		tempP1Act.addLast(Action.STAND_GUARD);

		Deque<Action> tempP2Act = new LinkedList<>();
		s.simulate(f.createFrameData(1, 1), true, tempP1Act, tempP2Act, 100);
