...
/**
 * The class dealing with the screen information such as the game screen's core.image
...
//		this.displayBufferedImage = GraphicManager.getInstance().getScreenImage();
	 ...
	 *
	 * @param newWidth
	 *            the width in pixel for the scaled core.image
	 * @param newHeight
	 *            the height in pixel for the scaled core.image
	 * @param grayScale
	 *            true to use grayScale for the scaled core.image (1 byte per pixel
